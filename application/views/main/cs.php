...
<html class="fixed">
	<head>
		...
		<title>Customer Service | SIADIK</title>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?= base_url() ?>assets/images/user-default.jpg" alt="Joseph Doe" class="img-circle" data-lock-picture="<?= base_url() ?>assets/images/!logged-user.jpg" />
							</figure>
